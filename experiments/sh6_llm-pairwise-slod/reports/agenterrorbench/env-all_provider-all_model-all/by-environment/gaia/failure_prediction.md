# SH6 agenterrorbench/env-all_provider-all_model-all/by-environment/gaia — Failure Prediction
...
- Negative class (`final_answer_correct=false`): 49
- Label agreement (`is_correct` vs `final_answer_correct`): 100.0% over 49 items
