...
| trajectory_shape (logreg) | 47 | 0.786 +/- 0.071 | 0.823 +/- 0.064 | 0.695 +/- 0.066 | 0.700 +/- 0.067 | 0.734 +/- 0.065 |
| trajectory_full (logreg) | 47 | 0.786 +/- 0.071 | 0.823 +/- 0.064 | 0.695 +/- 0.066 | 0.700 +/- 0.067 | 0.734 +/- 0.065 |
| trajectory_full (lightgbm) | 47 | 0.599 +/- 0.111 | 0.673 +/- 0.118 | 0.579 +/- 0.112 | 0.583 +/- 0.118 | 0.634 +/- 0.110 |
...
| answer_traj_t15 | shape | 0.713 | higher -> wrong |
| answer_traj_t03 | shape | 0.701 | higher -> correct |
...
| answer_traj_t14 | shape | 0.639 | higher -> wrong |
...
|---|---|---|---|
| answer_n_chunks | length | -1.456 | higher -> wrong |
| answer_traj_t05 | shape | 1.121 | higher -> correct |
| answer_traj_t09 | shape | -1.002 | higher -> wrong |
| answer_max_drop_pos | derailment | -0.950 | higher -> wrong |
| answer_traj_t10 | shape | 0.929 | higher -> correct |
| answer_max_drop | derailment | 0.905 | higher -> correct |
| answer_max | shape | 0.717 | higher -> correct |
| answer_zero_crossings | thrashing | -0.691 | higher -> wrong |
| answer_range | commitment | 0.649 | higher -> correct |
| answer_traj_t07 | shape | -0.571 | higher -> wrong |
| answer_std | shape | -0.531 | higher -> wrong |
| answer_traj_t02 | shape | -0.513 | higher -> wrong |
...
- `trajectory_full` ROC-AUC: **0.786**
- Above-chance discrimination preserved by the mode stack: **72.4%** ((AUC_modes − 0.5) ÷ (AUC_full − 0.5))
