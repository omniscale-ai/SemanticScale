...
| trajectory_shape (logreg) | 60 | 0.566 +/- 0.083 | 0.283 +/- 0.091 | 0.550 +/- 0.104 | 0.665 +/- 0.089 | 0.285 +/- 0.148 |
| trajectory_full (logreg) | 63 | 0.561 +/- 0.083 | 0.287 +/- 0.116 | 0.546 +/- 0.114 | 0.658 +/- 0.110 | 0.288 +/- 0.166 |
| trajectory_full (lightgbm) | 63 | 0.517 +/- 0.046 | 0.252 +/- 0.064 | 0.491 +/- 0.060 | 0.755 +/- 0.042 | 0.100 +/- 0.122 |
| mode_stack (logreg) | 10 | 0.629 +/- 0.023 | 0.394 +/- 0.110 | 0.532 +/- 0.065 | 0.613 +/- 0.098 | 0.287 +/- 0.057 |
...
| answer_monotonicity | commitment | 0.646 | higher -> correct |
| answer_direction_changes | thrashing | 0.642 | higher -> correct |
| reasoning_max_rise | shape | 0.639 | higher -> correct |

## Strongest Multivariate Coefficients

| Feature | Family | Coefficient | Direction |
|---|---|---|---|
| answer_zero_crossings | thrashing | 0.910 | higher -> correct |
| reasoning_monotonicity | commitment | 0.896 | higher -> correct |
| reasoning_curvature_abs_mean | thrashing | 0.871 | higher -> correct |
| reasoning_positive_mass | shape | -0.736 | higher -> wrong |
| reasoning_max | shape | 0.732 | higher -> correct |
| answer_n_chunks | length | -0.731 | higher -> wrong |
| answer_total_variation | thrashing | 0.701 | higher -> correct |
| answer_monotonicity | commitment | 0.686 | higher -> correct |
| answer_max_rise | shape | -0.683 | higher -> wrong |
| answer_positive_mass | shape | -0.670 | higher -> wrong |
| answer_start | shape | 0.647 | higher -> correct |
| reasoning_trough_pos | timing | -0.620 | higher -> wrong |
...
- `mode_stack` ROC-AUC: **0.629**
- `trajectory_full` ROC-AUC: **0.561**
- Above-chance discrimination preserved by the mode stack: **212.3%** ((AUC_modes − 0.5) ÷ (AUC_full − 0.5))
